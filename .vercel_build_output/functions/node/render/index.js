...
// .svelte-kit/output/server/chunks/index-f1ec7e8a.js
function run(fn) {
  return fn();
}
...
var import_theme_change, Theme_select, Navbar, load, _layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    init_index_f1ec7e8a();
    import_theme_change = __toModule(require_theme_change());
    Theme_select = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"mb-8"}"><select data-choose-theme class="${"pr-9 select-bordered select-primary select-xs text-primary-content bg-primary"}"><option disabled="${"disabled"}" selected="${"selected"}" value="${"Choose a theme"}">Choose a theme</option><option value="${"aqua"}">Aqua</option><option value="${"black"}">Black</option><option value="${"bumblebee"}">Bumblebee</option><option value="${"corporate"}">Corporate</option><option value="${"cupcake"}">Cupcake</option><option value="${"cyberpunk"}">Cyberpunk</option><option value="${"dark"}">Dark</option><option value="${"dracula"}">Dracula</option><option value="${"emerald"}">Emerald</option><option value="${"fantasy"}">Fantasy</option><option value="${"forest"}">Forest</option><option value="${"garden"}">Garden</option><option value="${"halloween"}">Halloween</option><option value="${"light"}">Light</option><option value="${"lofi"}">Lofi</option><option value="${"luxury"}">Luxury</option><option value="${"pastel"}">Pastel</option><option value="${"retro"}">Retro</option><option value="${"synthwave"}">Synthwave</option><option value="${"valentine"}">Valentine</option><option value="${"wireframe"}">Wireframe</option></select></div>`;
    });
    Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { pages } = $$props;
      if ($$props.pages === void 0 && $$bindings.pages && pages !== void 0)
        $$bindings.pages(pages);
      return `<div class="${"navbar m-10 mb-2 shadow-lg bg-neutral text-neutral-content rounded-box"}"><div class="${"px-2 mx-2 navbar-start"}"><a href="${"/"}" class="${"text-lg font-bold"}">SP Blog</a></div>

	<div class="${"mx-2 px-2 navbar-end"}"></div>
	<div class="${"flex items-stretch"}"><a href="${"/"}" class="${"btn btn-ghost btn-sm rounded-btn"}">Home </a>
		${each(pages, ({ title, slug }) => `<a${add_attribute("href", `/${slug}`, 0)} class="${"btn btn-ghost btn-sm rounded-btn"}">${escape(title)} </a>`)}</div>
	<div class="${"navbar-end"}">${validate_component(Theme_select, "ThemeSelect").$$render($$result, {}, {}, {})}</div></div>`;
    });
    load = async ({ fetch: fetch3 }) => {
      try {
        const res = await fetch3("/pages.json");
    ...
    _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.pages === void 0 && $$bindings.pages && pages !== void 0)
        $$bindings.pages(pages);
      return `${validate_component(Navbar, "Nav").$$render($$result, { pages }, {}, {})}
<main class="${"flex flex-col items-center m-auto"}">${slots.default ? slots.default({}) : ``}</main>`;
    });
  }
});
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    entry = "pages/__layout.svelte-89eda73d.js";
    js = ["pages/__layout.svelte-89eda73d.js", "chunks/vendor-c3bb1474.js"];
    css2 = ["assets/pages/__layout.svelte-407c7835.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    entry2 = "error.svelte-66c3a287.js";
    js2 = ["error.svelte-66c3a287.js", "chunks/vendor-c3bb1474.js"];
    css3 = [];
  }
});
...
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/index.svelte.js"() {
    ...
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${$$result.head += `${$$result.title = `<title>Blog | Bienvenido</title>`, ""}`, ""}

<div class="${"container w-10/12 mx-auto flex flex-col items-center"}"><h1 class="${"text-4xl mb-5 mt-10 font-extrabold"}">Welcome to SvelteKit</h1>
	<p>Visit <a href="${"https://kit.svelte.dev"}">kit.svelte.dev</a> to read the documentation</p>

	<div class="${"py-4 mt-10 flex flex-wrap gap-4"}">${each(posts, ({ title, coverImage, excerpt, tags, slug, author }) => `<div class="${"card card-bordered grow w-96 "}"><figure><img${add_attribute("src", coverImage.url, 0)}${add_attribute("alt", title, 0)}></figure>
				<div class="${"card-body relative"}"><div class="${"badge mb-2 badge-secondary"}">${escape(tags)}</div>
					<h2 class="${"card-title"}">${escape(title)}</h2>
					<p class="${"mb-16"}">${escape(excerpt)}</p>

					<div class="${"avatar absolute bottom-6 left-6"}"><div class="${"rounded-full w-10 h-10"}"><img${add_attribute("src", author.picture.url, 0)}${add_attribute("alt", title, 0)}></div>
						<p class="${"ml-2 mt-1"}">${escape(author.name)}</p></div>

					<div class="${"justify-end card-actions absolute bottom-6 right-6"}"><a${add_attribute("href", `/posts/${slug}`, 0)} class="${"btn btn-secondary"}">More info</a>
					</div></div>
			</div>`)}</div></div>`;
    });
  }
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_index_svelte();
    entry3 = "pages/index.svelte-7d1473da.js";
    js3 = ["pages/index.svelte-7d1473da.js", "chunks/vendor-c3bb1474.js"];
    css4 = [];
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    init_about_svelte();
    entry4 = "pages/about.svelte-e39a3aff.js";
    js4 = ["pages/about.svelte-e39a3aff.js", "chunks/vendor-c3bb1474.js"];
    css5 = [];
  }
});
...
var load4, U5Bslugu5D;
var init_slug_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/posts/_slug_.svelte.js"() {
    init_index_f1ec7e8a();
    load4 = async ({ fetch: fetch3, params }) => {
      const { slug } = params;
      const res = await fetch3(`/posts/${slug}.json`);
      if (res.ok) {
    ...
    U5Bslugu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.post === void 0 && $$bindings.post && post !== void 0)
        $$bindings.post(post);
      return `${$$result.head += `${$$result.title = `<title>Blog | ${escape(title)}</title>`, ""}`, ""}

<div class="${"sm:-mx-5 md:-ms-10 lg:-mx-20 xl:-mx-38 mb-5"}"><img${add_attribute("src", coverImage.url, 0)}${add_attribute("alt", title, 0)}></div>
<h1 class="${"text-4xl font-semibold mb-5 mt-5"}">${escape(title)}</h1>
<a href="${"/"}" class="${"inline-flex items-center mb-5"}"><img${add_attribute("src", picture.url, 0)}${add_attribute("alt", name, 0)} class="${"w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"}">
	<span class="${"flex-grow flex flex-col pl-4"}"><span class="${"title-font font-medium"}">${escape(name)}</span>
		<span class="${"text-secondary text-xs tracking-widest mt-0.5"}">${escape(authorTitle)}</span></span></a>

<p class="${"text-secondary text-xs tracking-widest font-semibold"}">${escape(new Date(date).toDateString())}</p>

<div class="${"mt-5 flex justify-between"}"><div>${tags ? `<div class="${"mt-5 space-x-2"}">${each(tags, (tag) => `<span class="${"badge badge-primary"}">${escape(tag)}</span>`)}</div>` : ``}</div></div>

<article class="${"prose"}"><!-- HTML_TAG_START -->${html}<!-- HTML_TAG_END --></article>`;
    });
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    init_slug_svelte();
    entry5 = "pages/posts/_slug_.svelte-b71dcc74.js";
    js5 = ["pages/posts/_slug_.svelte-b71dcc74.js", "chunks/vendor-c3bb1474.js"];
    css6 = [];
  }
});
...
var load5, U5Bslugu5D2;
var init_slug_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/_slug_.svelte.js"() {
    init_index_f1ec7e8a();
    load5 = async ({ fetch: fetch3, params }) => {
      const { slug } = params;
      const res = await fetch3(`/pages/${slug}.json`);
      if (res.ok) {
    ...
    U5Bslugu5D2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.page === void 0 && $$bindings.page && page !== void 0)
        $$bindings.page(page);
      return `${$$result.head += `${$$result.title = `<title>Blog | ${escape(page.title)}</title>`, ""}`, ""}

<div class="${"w-10/12"}"><h1 class="${"text-4xl font font-semibold mb-5"}">${escape(page.title)}</h1>
	<article class="${"prose"}"><!-- HTML_TAG_START -->${page.content.html}<!-- HTML_TAG_END --></article></div>`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    init_slug_svelte2();
    entry6 = "pages/_slug_.svelte-25ccd8e2.js";
    js6 = ["pages/_slug_.svelte-25ccd8e2.js", "chunks/vendor-c3bb1474.js"];
    css7 = [];
  }
});
    ...
    module2.exports = function extractFiles(value, path, isExtractableFile) {
      ...
      if (isExtractableFile(value)) {
        ...
        if (typeof FileList !== "undefined" && value instanceof FileList)
          clone2 = Array.prototype.map.call(value, function(file, i3) {
            addFile(["" + prefix + i3], file);
            return null;
          });
        else if (Array.isArray(value))
          clone2 = value.map(function(child, i3) {
            var result2 = extractFiles(child, "" + prefix + i3, isExtractableFile);
          ...
          clone2 = {};
          for (var i2 in value) {
            var result = extractFiles(value[i2], "" + prefix + i2, isExtractableFile);
            result.files.forEach(addFile);
            clone2[i2] = result.clone;
          }
        } else
          clone2 = value;
      }
...
var require_createRequestBody = __commonJS({
  "node_modules/graphql-request/dist/createRequestBody.js"(exports) {
    ...
    function createRequestBody(query, variables, operationName) {
      var _a4 = extract_files_1.extractFiles({ query, variables, operationName }, "", isExtractableFileEnhanced), clone2 = _a4.clone, files = _a4.files;
      if (files.size === 0) {
...
var require_dist = __commonJS({
  "node_modules/graphql-request/dist/index.js"(exports) {
    ...
    var buildGetQueryParams = function(_a4) {
      var query = _a4.query, variables = _a4.variables, operationName = _a4.operationName;
      if (!Array.isArray(query)) {
    ...
    var post = function(_a4) {
      var url = _a4.url, query = _a4.query, variables = _a4.variables, operationName = _a4.operationName, headers = _a4.headers, fetch3 = _a4.fetch, fetchOptions = _a4.fetchOptions;
    ...
    var GraphQLClient2 = function() {
      ...
      GraphQLClient3.prototype.request = function(document2, variables, requestHeaders) {
        return __awaiter(this, void 0, void 0, function() {
          var _a4, headers, _b, fetch3, _c, method, fetchOptions, url, _d2, query, operationName, data;
          return __generator(this, function(_e) {
            switch (_e.label) {
              case 0:
                ...
                url = this.url;
                _d2 = resolveRequestDocument(document2), query = _d2.query, operationName = _d2.operationName;
      ...
      GraphQLClient3.prototype.setHeader = function(key, value) {
        ...
        if (headers) {
          ...
          this.options.headers = (_a4 = {}, _a4[key] = value, _a4);
        }
        return this;
      };
    ...
    function makeRequest(_a4) {
      var url = _a4.url, query = _a4.query, variables = _a4.variables, headers = _a4.headers, operationName = _a4.operationName, fetch3 = _a4.fetch, _b = _a4.method, method = _b === void 0 ? "POST" : _b, fetchOptions = _a4.fetchOptions;
      return __awaiter(this, void 0, void 0, function() {
        var fetcher, isBathchingQuery, response, result, successfullyReceivedData, headers_1, status_1, errorResult;
        return __generator(this, function(_c) {
          switch (_c.label) {
            case 0:
              fetcher = method.toUpperCase() === "POST" ? post : get5;
            ...
            case 2:
              result = _c.sent();
              successfullyReceivedData = isBathchingQuery && Array.isArray(result) ? !result.some(function(_a5) {
                var data = _a5.data;
                return !data;
              }) : !!result.data;
...
// .svelte-kit/output/server/chunks/graphql-client-39a6a729.js
var import_graphql_request, GRAPHQL_ENDPOINT, client;
var init_graphql_client_39a6a729 = __esm({
  ".svelte-kit/output/server/chunks/graphql-client-39a6a729.js"() {
    import_graphql_request = __toModule(require_dist());
    GRAPHQL_ENDPOINT = process.env["GRAPHQL_ENDPOINT"];
    client = new import_graphql_request.GraphQLClient(GRAPHQL_ENDPOINT);
  }
});

// .svelte-kit/output/server/entries/endpoints/pages/index.json.js
var index_json_exports = {};
__export(index_json_exports, {
  get: () => get
});
var import_graphql_request2, get;
var init_index_json = __esm({
  ".svelte-kit/output/server/entries/endpoints/pages/index.json.js"() {
    init_graphql_client_39a6a729();
...
// .svelte-kit/output/server/entries/endpoints/pages/_slug_.json.js
var slug_json_exports = {};
__export(slug_json_exports, {
  get: () => get2
});
var import_graphql_request3, get2;
...
// .svelte-kit/output/server/entries/endpoints/posts/index.json.js
var index_json_exports2 = {};
__export(index_json_exports2, {
  get: () => get3
});
var import_graphql_request4, get3;
...
var import_graphql_request5, get4;
var init_slug_json2 = __esm({
  ".svelte-kit/output/server/entries/endpoints/posts/_slug_.json.js"() {
    ...
    get4 = async (req) => {
      const slug = req.params.slug;
      try {
        const query = import_graphql_request5.gql`
...
var manifest = {
  ...
  _: {
    mime: { ".png": "image/png" },
    entry: { "file": "start-934ba722.js", "js": ["start-934ba722.js", "chunks/vendor-c3bb1474.js"], "css": ["assets/start-d5b4de3e.css"] },
    nodes: [
